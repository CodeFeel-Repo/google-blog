CodeFeel님, 깃허브 저장소의 대문 역할을 할 깔끔한 `README.md` 마크다운 코드를 작성해 드립니다.

이 내용을 복사해서 깃허브 저장소 최상단에 `README.md` 파일로 만들어두시면, 나중에 코드를 다시 확인하거나 관리할 때 한눈에 파악하기 좋습니다.
...
**CSS 추가 (`<head>` 태그 내부):**
```html
<link rel="stylesheet" href="[https://cdn.jsdelivr.net/gh/](https://cdn.jsdelivr.net/gh/)[깃허브아이디]/[저장소이름]@main/code-block.css" />
...
```html
<!-- 코드 복사 기능 -->
<script src="[https://cdn.jsdelivr.net/gh/](https://cdn.jsdelivr.net/gh/)[깃허브아이디]/[저장소이름]@main/code-block.js"></script>
<!-- 불펌 방지 기능 -->
<script src="[https://cdn.jsdelivr.net/gh/](https://cdn.jsdelivr.net/gh/)[깃허브아이디]/[저장소이름]@main/protect.js"></script>
